...
class DocumentTest {
    ...
    void getContentIndexCaseA() {
        List<Content> contents = Arrays.asList(
            ...
            new Content(ID.nextId(), new Head((short) 3, "Head 3"), Index.of("lvl3"), null, new ArrayList<>(), new ArrayList<>()),
            new Content(ID.nextId(), new Head((short) 4, "Head 4"), Index.of("lvl4"), null, new ArrayList<>(), new ArrayList<>()),
